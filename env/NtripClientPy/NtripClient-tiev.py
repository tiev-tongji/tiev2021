    ...
    def readData(self):
        ...
        try:
            while reconnectTry<=maxReconnect:
                found_header=False
                if self.verbose:
                    #sys.stderr = open('errorlog_abc.txt', 'a') #edited by ljf
                ...
                if error_indicator==0:
                    ...
                    self.socket.settimeout(20) # edited by ljf
...
if __name__ == '__main__':
    ...
    parser.add_option("-S", "--serialDev", type="string", dest="serialDev", default=None, help="The serial device")
    parser.add_option("-B", "--baudRate", type="int", dest="baudRate", default=None, help="The baudrate of the serial device")
    ...
    ntripArgs['serialDev']=options.serialDev
    ntripArgs['baudRate']=options.baudRate
    ...
    if options.verbose:
        ...
        print "Serial device: " + ntripArgs['serialDev']
        print "Serial Baudrate: " + str(ntripArgs['baudRate'])
        if ntripArgs['V2']:
            print "NTRIP: V2"
        else:
            print "NTRIP: V1 "
