...
void send_m_ABS2HSC(can_frame * frame);
void get_m_EPS_HSC_FrP01(can_frame *frame);
void get_m_EPS2VMS(can_frame * frame);
void get_m_VCU2MAB_2(can_frame * frame);
void get_m_VCU2MAB_3(can_frame * frame);
void get_m_VCU2MAB_4(can_frame * frame);
void get_m_VCU2MAB_5(can_frame * frame);
void get_m_BSC2MCU(can_frame * frame);
void send_m_VMS2EPS(can_frame * frame, unsigned char EPS_remote_control_p, double SteeringTorque_Demand_p);
void send_m_MAB2VCU(can_frame * frame, unsigned char Motor_remote_control_p, double MotorTorque_Req_p);
void send_m_MCU2BSC(can_frame * frame, unsigned char BRK_URG_EN, unsigned char BRK_EN, double BRK_OBJ_PRUR_p);
