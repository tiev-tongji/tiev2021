...
#ifndef TiEV_PI
#define TiEV_PI (3.1415926535897932384626433832795)  //!< Pi.
#endif
#define DEG2RAD             (TiEV_PI/180.0)  //!< Convert degrees to radians.
#define RAD2DEG             (180.0/TiEV_PI)  //!< Convert radians to degrees.
...
static ParsedPacketType PktStatus(size_t Len, const unsigned char *p)
{
	...
	// Evaluate the checksum Commented by John 150728
