...
//{
//  dgc_perception_map_cells_p   obstacles_s_tmp;
//  dgc_grid_p grid_latest;
//  ~obstaclesStruct()
//  {
//    for(int i = 0;i < obstacles_s_tmp->num;i++){
//      free(obstacles_s_tmp->cell[i]);
//    }
//    free(obstacles_s_tmp);
//    //TODO add free
//  }
//};
