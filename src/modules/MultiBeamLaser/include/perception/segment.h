...
private:
  std::vector<std::tr1::shared_ptr<TiEV::Obstacle> >* regions_;
  dgc_grid_p grid_;
  double timestamp_;
...
public:
  ...
  void segmentGrid(dgc_grid_p grid, dgc_perception_map_cells_p obstacles, std::vector< std::tr1::shared_ptr<TiEV::Obstacle> >* regions, double timestamp);
};
