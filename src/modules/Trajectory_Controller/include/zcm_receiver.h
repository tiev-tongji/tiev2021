...
public:
    ...
    void handleAIMPATH(const zcm::ReceiveBuffer *rbuf, const std::string &channel, const structAIMPATH *msg);
    void handleCANINFO(const zcm::ReceiveBuffer *rbuf, const std::string &channel, const structCANINFO *msg);
    void handleNAVINFO(const zcm::ReceiveBuffer *rbuf, const std::string &channel, const structNAVINFO *msg);
...
public:
	...
	bool getCarStatus(double &current_velocity, double &current_steering_angle, double &current_yawrate);
	void zcmMsgReceive();
