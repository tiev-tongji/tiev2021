...
from imgaug import augmenters as iaa #hyy
...
class Apollo(data.Dataset):
    ...
    def __init__(self, mode, joint_transform=None,  transform=None, target_transform=None):
        ...
        # self.img_path_list = self.img_path_list[0: 100]
        ...
        self.augfn = iaa.Sequential([
               iaa.HistogramEqualization(),
               iaa.Dropout([0.00, 0.05]),
    ...
    def __getitem__(self, index):
        ...
        img, mask = self.augfn(image=img, segmentation_maps=mask)
