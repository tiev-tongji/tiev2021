...
class LaneLine
{
    ...
    public:
        ...
        static constexpr int8_t   TYPE_WHITE = 0x01;
        static constexpr int8_t   TYPE_YELLOW = 0x02;
        static constexpr int8_t   TYPE_SOLID = 0x03;
        static constexpr int8_t   TYPE_DASHED = 0x04;
        #else
        static const     int8_t   TYPE_WHITE = 0x01;
        static const     int8_t   TYPE_YELLOW = 0x02;
        static const     int8_t   TYPE_SOLID = 0x03;
        static const     int8_t   TYPE_DASHED = 0x04;
        #endif
...
int LaneLine::_encodeNoHash(void* buf, uint32_t offset, uint32_t maxlen) const
{
    ...
    thislen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->dis_to_veh, 1);
    if(thislen < 0) return thislen; else pos += thislen;
...
int LaneLine::_decodeNoHash(const void* buf, uint32_t offset, uint32_t maxlen)
{
    ...
    thislen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->dis_to_veh, 1);
    if(thislen < 0) return thislen; else pos += thislen;
