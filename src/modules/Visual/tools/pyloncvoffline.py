...
pretrained_model_path = str(Path(__file__).parent.parent /
    'ckpt/epoch_5_loss_0.06971_acc_0.97669_acc-cls_0.60299_mean-iu_0.44240_fwavacc_0.95725_lr_0.0002000000.pth')
