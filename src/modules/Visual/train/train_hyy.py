...
from wrsampler import WeightedRandomSampler
...
ckpt_path = '/mnt/ExtraDisk/hyy_vggsegnet_xiaozhou/'
exp_name = 'fcn8s'
...
def main():
    ...
    # train_set.get(1)
    sampler = WeightedRandomSampler(10000)
    train_loader = DataLoader(train_set, batch_size=args['train_batch_size'], num_workers=8, sampler=sampler)
