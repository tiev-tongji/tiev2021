...
private:
    ...
    */
    ...
    public:
        ...
        double get_average_curvature() const {
            return average_curvature;
        }
        bool get_is_backward() const {
            return is_backward;
        }
    ...
    public:
        ...
        double get_begin_curvature() const {
            return begin_curvature;
        }
        double get_end_curvature() const {
            return end_curvature;
        }
    ...
    public:
        virtual const vector<const base_primitive*>&
        get_nexts(const astate& state) const = 0;
        virtual const vector<const base_primitive*>&
        get_nexts(const primitive& primitive) const = 0;
    };
    ...
    public:
        ...
        virtual const vector<const base_primitive*>&
        get_nexts(const astate& state) const;
        virtual const vector<const base_primitive*>&
        get_nexts(const primitive& primitive) const;
...
#error define at least one flag to set which type of primitives to use
    ...
    public:
        ...
        virtual bool
        traverse(const function<bool(const astate&)>& callback) const = 0;
    ...
    public:
        ...
        virtual bool
        traverse(const function<bool(const astate&)>& callback) const;
    ...
    public:
        reeds_shepp_provider(const astate& _start_state,
...
#define dec(a) ((a + (buffer_size - 1)) % buffer_size)
            ...
            void push_front(const T& t) {
                buffer[begin_idx = dec(begin_idx)] = t;
            }
