...
constexpr float CAR_WIDTH              = 2.0;   //(m)
...
constexpr double COLLISION_CIRCLE_SMALL_R = 1.15;  // m

constexpr double circle_dis2 = -((CAR_LENGTH + CAR_BUMPER_LENGTH) / 2 - (CAR_FRONT_AXLE_TO_HEAD + CAR_BUMPER_LENGTH));
