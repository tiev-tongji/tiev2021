...
public:
    ...
    void set_bottom_left_point(STPoint p) {
        bottom_left_point_ = p;
    }

    void set_bottom_right_point(STPoint p) {
        bottom_right_point_ = p;
    }

    void set_upper_left_point(STPoint p) {
        upper_left_point_ = p;
    }

    void set_upper_right_point(STPoint p) {
        upper_right_point_ = p;
    }
    ...
    bool GetUnblockSRange(const double curr_time, const double total_path_length, double* s_upper, double* s_lower) const;
};
}
