...
public:
    ...
    uint32_t matrix_dimension_s() const {
        return matrix_dimension_s_;
    }

    uint32_t matrix_dimension_t() const {
        return matrix_dimension_t_;
    }

    double vehicle_upper_speed_limit() const {
    ...
    double positive_jerk_weight() const {
        return positive_jerk_weight_;
    }

    double negative_jerk_weight() const {
        return negative_jerk_weight_;
    }
};
}
