#ifndef CIRCLEFITBYTAUBIN_H
#define CIRCLEFITBYTAUBIN_H
#include "fitdata.h"
#include "fitcircle.h"
#include "Utilities.cpp"
FitCircle CircleFitByTaubin(FitData& data)
/*  
...
//     computing moments 
    ...
    for (i=0; i<data.n; i++)
    {
        Xi = data.points[i].first - data.meanX;   //  centered x-coordinates
        Yi = data.points[i].second - data.meanY;   //  centered y-coordinates
        Zi = Xi*Xi + Yi*Yi;
