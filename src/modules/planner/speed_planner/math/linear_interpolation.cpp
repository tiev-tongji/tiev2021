...
Point InterpolateUsingLinearApproximationWithT(const Point &p0, const Point &p1, const double t) {
    double t0 = p0.t;
    double t1 = p1.t;
    ...
    p.angle.setByRad(slerp(p0.angle.getRad(), t0, p1.angle.getRad(), t1, t));
...
Point InterpolateUsingLinearApproximationWithS(const Point& p0, const Point& p1, const double s) {
    double s0 = p0.s;
    double s1 = p1.s;
    ...
    double theta = slerp(p0.angle.getRad(), s0, p1.angle.getRad(), s1, s);
    double kappa = (1 - weight) * p0.k + weight * p1.k;
    path_point.x = x;
    path_point.y = y;
    path_point.angle.setByRad(theta);
    path_point.k = kappa;
    path_point.s = s;
