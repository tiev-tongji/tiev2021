...
#define FLAGS_speed_lower_bound 1
#define FLAGS_speed_upper_bound 1
#define FLAGS_longitudinal_acceleration_lower_bound 1
#define FLAGS_longitudinal_acceleration_upper_bound 1
#define FLAGS_longitudinal_jerk_lower_bound 1
#define FLAGS_longitudinal_jerk_upper_bound 1
#define FLAGS_trajectory_time_resolution 1
#define FLAGS_lateral_acceleration_bound 1
#define FLAGS_lateral_jerk_bound 1
#define FLAGS_trajectory_time_resolution 1
