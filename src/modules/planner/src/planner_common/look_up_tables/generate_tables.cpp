...
int main() {
    ReedsSheppTableHelper::generate_distance_table_file(560, 0.1, 72, 27.5, reeds_shepp_distance_table_file_name);
    DubinsTableHelper::generate_distance_table_file(560, 0.1, 72, 27.5, dubins_distance_table_file_name);
    return 0;
}