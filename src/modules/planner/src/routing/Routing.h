...
public:
     ...
     */
    int findReferenceRoad(std::vector<std::pair<double, double>> task_points, bool blockeds = false);
...
private:
    ...
    void Array2Str(std::vector<std::pair<double, double>> task_points, std::string &array_x_str, std::string &array_y_str);
};
#endif