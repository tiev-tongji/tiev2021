#include "path_time_heuristic/st_graph_point.h"

namespace TiEV {

uint32_t StGraphPoint::index_s() const {
    return index_s_;
}

uint32_t StGraphPoint::index_t() const {
    return index_t_;
}

const STPoint& StGraphPoint::st_point() const {
    return st_point_;
}
