...
bool SpeedData::AppendSpeedPoint(const double s, const double tt,
...
double SpeedData::TotalTime() const { return back().t() - front().t(); }

double SpeedData::TotalLength() const { return back().s() - front().s(); }
