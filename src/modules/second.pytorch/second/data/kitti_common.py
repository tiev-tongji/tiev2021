...
def _check_kitti_directory(root_path):
    ...
    results.append(len(path_train_image_2.glob('*.png')) == 9)
    ...
    results.append(len(path_train_label_2.glob('*.txt')) == 9)
    results.append(len(path_train_lidar.glob('*.bin')) == 9)
    results.append(len(path_train_calib.glob('*.txt')) == 9)
    path_test_image_2 = path / 'testing' / 'image_2'
    results.append(path_test_image_2.exists())
    results.append(len(path_test_image_2.glob('*.png')) == 9)
    ...
    results.append(len(path_test_lidar.glob('*.bin')) == 9)
    results.append(len(path_test_calib.glob('*.txt')) ==9)
