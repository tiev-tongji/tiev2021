...
class LANE(object):
    ...
    def _encode_one(self, buf):
        ...
        assert self.stop_point._get_packed_fingerprint() == LinePoint._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.stop_point = LinePoint._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x64f90884723f9b46+ LinePoint._get_hash_recursive(newparents)+ LaneLine._get_hash_recursive(newparents)+ LaneLine._get_hash_recursive(newparents)) & 0xffffffffffffffff
